            ...
            <section className='container fw-bold p-5'>
                <div className='row justify-content-center align-items-center'>
                    ...
                    <div className='col-md-8 my-4 text-center'>
                        ...
                        <p className='justified-text pt-3 fs-1'> Creemos en el poder del movimiento y en el potencial ilimitado de cada persona. Nuestro equipo de expertos te guiará en cada paso del camino, diseñando planes de entrenamiento personalizados para ayudarte a alcanzar tus metas. </p>
                    </div>
                </div>
                <div >
