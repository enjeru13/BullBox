    ...
    return (
        <>
            ...
            <section className="bg-image text-center text-white fw-bold">
                <div className=''>
                    <h2 className='fw-bold display-4'>HAZ QUE <span className='text-warning fw-bold'>OCURRA</span></h2>
                    <h5 className=''>Triunfar es mas facil de lo que piensas !</h5>
                    <hr className='text-warning' />
                    <h2 className='fw-bold display-4'>ENTRENA <span className='text-warning fw-bold'>GRATIS HOY ! </span> </h2>
            ...
            <section className='container fw-bold p-5'>
                <div className='row justify-content-center align-items-center'>
                    ...
                    <div className='col-md-8 my-4 text-center'>
                        ...
                        <p className='justified-text pt-3 fw-bold'> Creemos en el poder del movimiento y en el potencial ilimitado de cada persona. Nuestro equipo de expertos te guiará en cada paso del camino, diseñando planes de entrenamiento personalizados para ayudarte a alcanzar tus metas. </p>
                    </div>
                </div>
                <div >
            ...
            <section className='bg-image-servicios fw-bold p-5 text-center text-white'>
                <div className='row justify-content-center align-items-center'>
                    <div className='col-md-8 my-4 text-center'>
                        ...
                        <p className='justified-text pt-3 fw-bold'> ¿Sueñas con un cuerpo más fuerte y saludable?, te ofrecemos todo lo que necesitas para alcanzar tus metas. Desde entrenamientos personalizados hasta clases grupales dinámicas, te guiaremos paso a paso en tu transformación física y mental. </p>
                    </div>
                    <div className='col-md-4'>
            ...
            <div className="card text-center m-4 fw-bold bg-dark text-white">
                <div className="card-header border-warning">
                    <h2 className="text-center fw-bold"><i className='me-3'><FontAwesomeIcon icon={faDumbbell} /></i>Clases de <span className='text-warning fw-bold'>Levantamiento de Pesas</span></h2>
                </div>
                <div className="card-body">
                    <p className="card-text text-center fw-bold">El levantamiento de pesas es el ejercicio perfecto para tonificar tus músculos y esculpir tu cuerpo. ¡Anímate a probarlo!</p>
                </div>
            </div>

            <div className="card text-center m-4 fw-bold bg-dark text-white">
                <div className="card-header border-warning">
                    <h2 className=" fw-bold card-title text-center"><i className='me-3'><FontAwesomeIcon icon={faWeightHanging} /></i>Clases de <span className='text-warning fw-bold'>Crosstraining</span></h2>
                </div>
                <div className="card-body">
                    <p className="card-text text-center fw-bold">Combina ejercicios funcionales, constantemente variados y ejecutados a alta intensidad, para mejorar tu fuerza, resistencia y condición física general. ¡Descubre tu potencial!</p>
                </div>
            </div>

            <div className="card text-center m-4 fw-bold bg-dark text-white">
                <div className="card-header border-warning">
                    <h2 className=" fw-bold card-title text-center"><i className='me-3'><FontAwesomeIcon icon={faPersonRunning} /></i>Entrenamientos <span className='text-warning fw-bold'>GAP</span></h2>
                </div>
                <div className="card-body">
                    <p className="card-text text-center fw-bold">Este entrenamiento se enfoca en fortalecer glúteos, abdomen y piernas, logrando una figura más tonificada y definida. ¡Ideal para quienes buscan resultados rápidos y efectivos!</p>
                </div>
            </div>
