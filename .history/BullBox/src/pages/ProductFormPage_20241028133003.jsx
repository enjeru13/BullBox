  ...
  return (
    <div className="flex h-[calc(100vh-100px)] items-center justify-center">
      <div className="max-w-md p-10 rounded-md">
        ...
        >
          <h1 className="text-2xl font-bold p-2">Agrega un Nuevo Producto</h1>
          ...
          <button
            type="submit"
            className="bg-indigo-600 w-full p-3 text-white font-bold uppercase rounded-md hover:bg-indigo-700 cursor-pointer transition-all my-2"
          >
            Agregar
          </button>
        </form>
