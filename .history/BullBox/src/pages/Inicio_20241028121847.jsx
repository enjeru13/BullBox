    ...
    return (
        <>
            ...
            <section className="bg-image text-center text-white fw-bold">
                <div className=''>
                    <h2 className='font-bold display-4'>HAZ QUE <span className='text-warning'>OCURRA</span></h2>
                    <h4 className=''>Triunfar es mas facil de lo que piensas !</h4>
                    <hr className='text-warning' />
                    <h2 className='fw-bold display-4'>ENTRENA <span className='text-warning'>GRATIS HOY ! </span> </h2>
                    <h4 className=''>Primera Clase Gratis !</h4>
                </div>
            </section>
