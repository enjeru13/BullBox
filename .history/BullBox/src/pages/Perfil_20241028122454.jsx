  ...
  return (
    <>
      <div className="perfil-container">
        {isAuthenticated ? (
          <>
            <h2 className="text-center m-4 fw-bold">Un gusto tenerte de vuelta {user.username || 'Usuario'}</h2>
            <div className="user-data text-center">
              <div className="card m-4">
                <div className="card-body">
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item"><strong>Nombre de usuario:</strong> {user.username || 'No disponible'}</li>
