  ...
  return (
    <>
      ...
      <section className="container fw-bold p-5">
        <div className="row justify-content-center align-items-center">
          ...
          <div className="col-md-8 my-4 text-center">
            <div className="text-warning fw-bold display-1">01</div>
        ...
        <div>
          <h1 className="text-center pt-3 pb-3 text-warning fw-bold">
            Nuestra ubicacion
          </h1>
          <Mapa />
        </div>
      ...
      <section className="bg-image-servicios fw-bold p-5 text-center text-white">
        <div className="row justify-content-center align-items-center">
          <div className="col-md-8 my-4 text-center">
            <div className="text-warning fw-bold display-1">02</div>
            <span className="fw-bold">LA MEJOR EXPERIENCIA</span>
      ...
      <div className="card text-center m-4 fw-bold bg-dark text-white">
        ...
        <div className="card-body">
          <p className="card-text text-center fw-bold">
            El levantamiento de pesas es el ejercicio perfecto para tonificar
            tus músculos y esculpir tu cuerpo. ¡Anímate a probarlo!
          </p>
        </div>
      </div>
      ...
      <div className="card text-center m-4 fw-bold bg-dark text-white">
        ...
        <div className="card-body">
          <p className="card-text text-center fw-bold">
            Combina ejercicios funcionales, constantemente variados y ejecutados
            a alta intensidad, para mejorar tu fuerza, resistencia y condición
            física general. ¡Descubre tu potencial!
          </p>
        </div>
      </div>
      ...
      <div className="card text-center m-4 fw-bold bg-dark text-white">
        <div className="card-header border-warning">
          <h2 className=" fw-bold card-title text-center">
            ...
            Entrenamientos <span className="text-warning fw-bold">GAP</span>
          </h2>
        </div>
        <div className="card-body">
          <p className="card-text text-center fw-bold">
            Este entrenamiento se enfoca en fortalecer glúteos, abdomen y
            piernas, logrando una figura más tonificada y definida. ¡Ideal para
      ...
      <section className="bg-image-planes fw-bold p-5 text-center text-white">
        <div className="">
          <div className="text-warning fw-bold display-1">03</div>
          <span className="fw-bold">LA MEJOR EXPERIENCIA</span>
          <h2 className="text-warning fw-bold display-4">Planes</h2>
        </div>
        <p className="justified-text pt-3 fw-bold">
          Elige el plan que se adapte a tu estilo de vida y alcanza tus
          objetivos de forma rápida y segura. Ofrecemos planes personalizados
          con entrenamiento funcional, cardiovascular y asesoramiento
          nutricional para optimizar tus resultados. ¡Únete a nuestra comunidad
          fitness y descubre tu máximo potencial !{" "}
        </p>
        <div className="row row-cols-1 row-cols-md-3 g-5 pt-5">
          <div className="col">
            <div className="bg-card card h-100">
              <div className="card-body">
                <h5 className="card-title text-center text-warning display-3 fw-bold m-3 border-bottom border-3 border-warning">
                  2 BULL
                </h5>
                <p className="card-text text-center text-white fs-1 fw-bold">
                  2 CLASES POR SEMANA
                </p>
                <br />
          ...
          <div className="col">
            <div className="bg-card card h-100">
              <div className="card-body">
                <h5 className="card-title text-center text-warning display-3 fw-bold border-bottom border-3 border-warning">
                  FULL BOX
                </h5>
                <br />
                <p className="card-text text-center text-white fs-1 fw-bold ">
            ...
            <div className="modal-dialog">
              <div className="modal-content bg-dark">
                <div className="modal-header">
                  <h1
                    className="modal-title text-warning fs-4"
                ...
                <p className="text-warning text-center fs-5">
                  QR Banco de Venezuela
                </p>
                <img src={QRvzla} alt="QR banco de Venezuela" />
                <p className="text-warning text-center fs-5 pt-3">
                  QR Banco de Venezuela
                </p>
                <img src={QRvzla} alt="" />
                <p className="text-warning text-center fs-5">
